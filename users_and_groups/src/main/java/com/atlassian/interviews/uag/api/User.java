...
public class User implements Comparable<User> {
	...
	/**
	 * Creates a new instance of a user. This does not implicitly register the user
	 * with the {@link UserService}.
	 *
	 * @param name the unique name that identifies this user; must not be
	 *             {@code null}.
	 */
